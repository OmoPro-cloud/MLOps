...
compiler.Compiler().compile(pipeline_func=training_pipepline, package_path="iris_pipeline.yaml")

#to run the pipeline use the kfp sdk or ui to upload and execute the generated yaml files
import kfp
client = kfp.Client()
